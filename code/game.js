...
Level.prototype.playerTouched = function(type, actor) {
  ...
  if (type == "lava" && this.status == null) {
    ...
    this.finishDelay = 1;
	  ...
	  var jumpSpeed = 40;
	  console.log(jumpSpeed); // tried for hours and asked on forum post but still couldn't get intended result :( it changes the speed for a second but doesn't reflect movement on character
